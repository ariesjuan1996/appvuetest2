  ...
  export default {
    ...
    computed:{
      ...
      credencialesFacebook(){
        let credFace={"clavepublica":"3653332591376169","claveprivada":"b7fc87b52d6b683d0661fa174e621d23"};

        return credFace;
      },
      credencialesGoogle(){
        let credFace={"clavepublica":"124037171005-h11uu90d3u59upaod4iudcedv3j8sv0n.apps.googleusercontent.com","claveprivada":"ZchjxAjDir2Ac9832gst6np4"};
    ...
    watch:{
      ...
      dialog(newVal){
        this.$emit("cambiarDialogo",newVal);
      },
     async emailSocial(){
